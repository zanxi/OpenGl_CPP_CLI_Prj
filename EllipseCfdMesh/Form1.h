...
#pragma endregion
			 void Ellipse()
			 {
				 ...
				 double centrex = 0;
				 double centrey = 0;
				 double m_axis = 0.5;// Convert::ToDouble(this->MinAx->Text);
			 ...
			 void NormalIB()
			 {
				 ...
				 {
					 double theta = -Math::PI / 4.0;
					 double b = 0.5; // Convert::ToDouble(this->MinAx->Text);
					 for (i = 0; i<N; i++)
					 {
			 ...
			 void Mesh()
			 {
				 ...
				 {
					 sw = 4;
					 p = 1.8; //Convert::ToDouble(this->P->Text);
					 q = 2.0; // Convert::ToDouble(this->Q->Text);
				 }
				 ...
				 {
					 sw = 6;
					 st = 1.3; //Convert::ToDouble(this->ST1->Text);
					 st2 = 0.33;// Convert::ToDouble(this->ST_2->Text);
					 d = 1.0;// Convert::ToDouble(this->D->Text);
					 this->NormalIB();
					 p = 1.0;
					 q = 2.0;
					 ...
					 if (this->CHcheck->Checked)
					 {
						 double dxdst, dydst, dhdst, targeth = 0.0001;// Convert::ToDouble(this->CH->Text);
				 ...
				 {
					 sw = 7;
					 p = 0.1;// Convert::ToDouble(this->P->Text);
					 q = 2.0;// Convert::ToDouble(this->Q->Text);
					 if (this->Scale->Checked)
						 choice = 0;
					 if (this->Interpolate->Checked)
					 ...
					 if (this->ProgGenOut->Checked)
						 choice = 2;
					 sc = 1.1;// Convert::ToDouble(this->S3->Text);
					 st = 1.0;// Convert::ToDouble(this->S4->Text);
					 al = 0.65;// Convert::ToDouble(this->AL->Text);
					 d = 1.0;// Convert::ToDouble(this->D->Text);
					 this->NormalIB();
					 if (this->CHcheck->Checked)
					 {
						 double dxdP, dydP, dhdP, targeth = 0.0001;// Convert::ToDouble(this->CH->Text);
